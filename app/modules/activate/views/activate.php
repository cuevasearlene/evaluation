...
<html>
    <head>
        ...
        <title>Activation | Evaluation</title>
        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                ...
                <div class="panel-heading bg-img"> 
                    ...
                    <h3 class="text-center m-t-10 text-white"> Activate My Account</h3>
                </div> 

                <div class="panel-body">
                   <?php echo $this->general->flash_message(); ?>
                 <form method="post" action="<?php echo site_url('activate') ?>/verify" role="form" class="text-center"> 
                    <div class="form-group m-b-0"> 
                            <input  class="form-control input-lg" placeholder="Enter Phone Number" data-mask="+639999999999" name="number" value="<?php echo $this->session->number; ?>"> 
                        </div> 
                        <br/>
                         <div class="input-group"> 
                            <input type="text" class="form-control input-lg" placeholder="Enter Code" name="code" value="<?php echo $this->session->code; ?>"> 
                            <span class="input-group-btn"> <button type="submit" class="btn btn-lg btn-success waves-effect waves-light">Activate!</button> </span> 
                        </div> 
                        <br/>
                        <div class="col-sm-12">
                             <button class="btn-link" id="resend_activation" type="button"><i class="fa fa-paper-plane m-r-5"></i> Resend Activation Code?</button>
                        </div>
