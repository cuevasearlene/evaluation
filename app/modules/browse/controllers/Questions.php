    ...
    function get_question_list(){
       ...
       $this->db->select('question, category');
        ...
        foreach ($list as $val) {
            ...
            $row['action'] = '<button class="btn btn-default waves-effect waves-light btn-xs m-b-5 add_exists_question" data-category="'.$row['id'].'"><i class="fa fa-plus"> Add </i></button>';
            $data[] = $row;
        }
