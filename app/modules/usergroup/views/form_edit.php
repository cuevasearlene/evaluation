		...
		<div class="row">
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="clearfix">
						<form action="<?php echo site_url($controller.'/update'); ?>" id="form-table" autocomplete="off" method="post" role="form">
							<div class="form-group">
								<label for="gname" class="col-xs-2 control-label required">Group Name</label>
								<div class="col-sm-5">
									<input type="text" name="gname" id="gname" class="form-control" value="<?php echo $data_edit->gname; ?>">
									<input type="hidden" name="old_gname" id="gname" class="form-control" value="<?php echo $data_edit->gname; ?>">
								</div><br/>
							</div>
							<div class="form-group">
								<div class="col-sm-12">
									<?php $get_module = $this->general->get_module(array('parent_id' => 0)); ?>
									<?php $role_data = json_decode($data_edit->role); ?>
							...
							<div class="form-group" >
								<div class="col-sm-12">
									<br/>
									<?php if($this->general->mod_access('user_group', 'alter')): ?>
