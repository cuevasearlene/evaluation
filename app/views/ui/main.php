        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="navbar navbar-default" role="navigation">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                <li class="dropdown hidden-xs">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-lg">
                                        <li class="text-center notifi-title"></li>
                                        <li class="list-group">
                                           <!-- list item-->
                    ...
                    <li class="dropdown">
                        <div data-toggle="modal" data-target="#qrcode_login" data-tt="tooltip"  data-placement="bottom" title="Login using qr code">Login</div>
                    </li>
                </ul>
